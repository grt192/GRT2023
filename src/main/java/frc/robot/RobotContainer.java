...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        switch (Constants.DT_TYPE) {
            ...
            case SWERVE_2020:
                ...
                gripperSubsystem = null;
                rollerSubsystem = null;
        ...
        if (driveSubsystem instanceof BaseSwerveSubsystem) {
            ...
            autonChooser.addOption("Rotating S-curve", new FollowPathCommand(
                    ...
                    new Pose2d(3, 0, Rotation2d.fromDegrees(90))).andThen(
            ...
            autonChooser.addOption("Box auton", new FollowPathCommand(
                    ...
                    new Pose2d(),
                    List.of(),
                    new Pose2d(2, 0, new Rotation2d())).andThen(
                            new FollowPathCommand(
                                    swerveSubsystem,
            ...
            autonChooser.addOption("GRT path", new FollowPathCommand(
                    ...
                    new Pose2d(),
                    List.of(),
                    new Pose2d(1, 1, new Rotation2d())).andThen(
                            new FollowPathCommand(
                                    swerveSubsystem,
    ...
    private void configureButtonBindings() {
        ...
        if (driveSubsystem instanceof BaseSwerveSubsystem) {
            ...
            driveController.getFieldResetButton()
                    .onTrue(new InstantCommand(swerveSubsystem::resetFieldAngle, swerveSubsystem));
