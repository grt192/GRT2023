...
public class SwerveModule implements BaseSwerveModule{
    ...
    private static final double DRIVE_ROTATIONS_TO_METERS = (1.0 / 3.0) * (13.0 / 8.0) * (1.0 / 3.0) * Math.PI
            * Units.inchesToMeters(4.0); // 3:1, 8:13, 3:1 gear ratios, 4.0" wheel diameter, circumference = pi * d
    ...
    /**
     * Constructs a SwerveModule from a drive and steer motor CAN ID and an angle
     * offset.
     * The offset will be applied to all angle readings to change the zero point of
     * the
     * module.
     * 
    ...
    /**
     * Utility class to construct a top left swerve module from a module's pin
     * offset.
     * The offset to align the pin with the front of the robot is automatically
     * applied.
     */
    ...
    /**
     * Utility class to construct a top right swerve module from a module's pin
     * offset.
     * The offset to align the pin with the front of the robot is automatically
     * applied.
     */
    ...
    /**
     * Utility class to construct a bottom left swerve module from a module's pin
     * offset.
     * The offset to align the pin with the front of the robot is automatically
     * applied.
     */
    ...
    /**
     * Utility class to construct a bottom right swerve module from a module's pin
     * offset.
     * The offset to align the pin with the front of the robot is automatically
     * applied.
     */
