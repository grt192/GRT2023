...
public class BNonBalanceAuton extends AutonAutonSequence{
     ...
     */
    public BNonBalanceAuton(RobotContainer robotContainer,  Pose2d initialPose, Pose2d placePose1, Pose2d pickPose, Pose2d placePose2,  MoverPosition height, MoverPosition height2){
