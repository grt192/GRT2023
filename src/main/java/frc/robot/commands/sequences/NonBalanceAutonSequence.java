...
public class NonBalanceAutonSequence extends SequentialCommandGroup{
    private final RobotContainer robotContainer;
    private final SwerveSubsystem swerveSubsystem;
    private final GripperSubsytem gripperSubsytem;
    private final MoverSubsystem moverSubsystem;

    public NonBalanceAutonSequence(RobotContainer robotContainer, Pose2d initialPose, Pose2d placePose, Pose2d grabPose, Pose2d placePose2, MoverPosition moverPosition, MoverPosition moverPosition2){
